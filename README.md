...
獅尾B2腿黑體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)的轉角的三角形轉成半圓形改造，彷彿墨暈或是稍微過曝的效果。支援简体中文、繁體中文、韓文與日文；歡迎大家自由應用、自由優化、自由改作！

和思源黑體一樣，支援7種的字重：
![字體預覽](https://github.com/max32002/swei-b2-leg/raw/master/preview/compare_style.png)
